...
# 爬虫配置
BASE_URL = "https://journal11.magtechjournal.com/cjcnn"
ARCHIVE_URL = "https://journal11.magtechjournal.com/cjcnn/CN/archive_by_years"
...
def extract_pdfs_from_volumn(vol_url):
    ...
    for article_div in article_divs:
        ...
        # 提取卷期信息和DOI
        # 注意：这里是j-volumn-doi，不是j-volume-doi（拼写不同）
        ...
        if volume_doi_div:
            ...
            if volume_span:
                ...
                # 匹配格式：中国现代神经疾病杂志。2025，25(12)：1087-1094.
