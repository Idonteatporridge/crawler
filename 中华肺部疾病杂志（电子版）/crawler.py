...
# 中华肺部疾病杂志（电子版）爬虫配置
BASE_URL = "https://zhfbjbzz.cma-cmc.com.cn"
ARCHIVE_URL = "https://zhfbjbzz.cma-cmc.com.cn/CN/article/showOldVolumn.do"
CSV_FILE = "zhfbjbzz_all_pdfs.csv"
...
# 主程序
def main():
    print("开始爬取中华肺部疾病杂志（电子版）过刊PDF链接...")
